...
local root_dir = vim.fn.getcwd()  -- obtiene el directorio actual
...
return {
  {
    ...
    keys = {
      ...
      },
      {
        ...
        function()
          local count = vim.v.count1
          require("toggleterm").toggle(count, 10, root_dir, "horizontal")
        end,
      ...
      },
      {
        "<leader>tt",
        function()
          require("toggleterm").toggle(1, 100, root_dir, "tab")
        end,
